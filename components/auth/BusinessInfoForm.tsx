            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <label
                    htmlFor="logo-upload"
                    className="border-2 border-dashed border-[#E5E7EB] rounded-lg p-10 text-center hover:border-[#D1D5DB] hover:bg-[#F9FAFB] transition-all cursor-pointer flex flex-col items-center gap-3"
                  >
                    {logoPreview ? (
                      <Image
                        width={80}

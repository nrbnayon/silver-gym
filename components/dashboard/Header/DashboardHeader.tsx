            ...
            {actions.length > 0 &&
              actions.map((action) => (
                <button
                  ...
                  className="flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 bg-white border border-gray-300 hover:bg-gray-50 rounded-sm transition-colors text-sm font-medium text-[#878787]"
                >
                  <HugeiconsIcon
                    icon={action.icon}
                    className="text-[#878787] w-5 h-5"
                  />
